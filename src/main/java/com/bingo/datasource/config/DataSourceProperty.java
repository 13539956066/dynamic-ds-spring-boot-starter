...
import com.bingo.datasource.config.hikari.HikariDataSourceConfig;
import com.bingo.datasource.config.druid.DruidDataSourceConfig;
import com.justbon.decrypt.util.DESUtil;
...
public class DataSourceProperty {
    ...
    private String decrypt(String cipherStr) {
        return DESUtil.decrypt(publicKey, cipherStr);
    }
}
