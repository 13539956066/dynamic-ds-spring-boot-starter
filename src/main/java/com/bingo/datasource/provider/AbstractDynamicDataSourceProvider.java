package com.bingo.datasource.provider;

import com.bingo.datasource.constant.DsConstants;
import com.bingo.datasource.creator.DataSourceCreator;
import com.bingo.datasource.creator.DruidDataSourceCreator;
import com.bingo.datasource.creator.HikariDataSourceCreator;
import com.bingo.datasource.config.DataSourceProperty;
import com.bingo.datasource.config.DynamicDataSourceProperties;
import com.bingo.datasource.config.druid.DruidDataSourceConfig;
...
public abstract class AbstractDynamicDataSourceProvider implements DynamicDataSourceProvider {
    ...
    Logger log = LoggerFactory.getLogger(AbstractDynamicDataSourceProvider.class);
